...
function Queue() {
    ...
    const indexFromClientY = (clientY: number) => {
        ...
        const local = Math.max(0, Math.min(viewCount - 1, Math.floor(rel / ROW_PX)));
    ...
    return (
        <div
            class="fixed inset-0 z-40 flex items-end justify-center sm:items-center p-0 sm:p-4"
            role="presentation"
        >
            <button
                type="button"
                ...
                >
                    {songs.length === 0 ? (
                        <div class="flex min-h-40 flex-col items-center justify-center gap-2 px-4 py-10 text-center text-sm text-zinc-500">
                            <p>Cola vacía.</p>
                            <p class="text-xs text-zinc-600">Elige una lista y pulsa un tema para empezar.</p>
                        </div>
                    ) : (
                        <div
                                ...
                                return (
                                    <div
                                        ...
                                        class={cn(
                                            ...
                                            isDropTarget && "bg-(--dominant-color)/15 ring-1 ring-(--dominant-color)/40 ring-inset",
                                    ...
                                    >
                                            ...
                                            {isCurrent &&
                                                (isLoading.value ? (
                                                    ...
                                                    isPlaying.value ? (
                                                        ...
                                                        <Pause size={25} class="absolute inset-0 z-10 m-auto fill-(--dominant-color) drop-shadow-md drop-shadow-black" />
                                                    )
                                                )
                                            }
                                        </div>
                                        <div class="min-w-0 flex-1 pr-1">
                                            <p
                                                class="truncate text-[13px] leading-tight sm:text-sm text-zinc-100"
                                            >
                                                {song.name}
                                            </p>
