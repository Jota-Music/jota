...
func TestCatalogRoutesByPrefix(t *testing.T) {
	...
	wantSpotify := []string{"full:spotify:playlist:abc", "revalidate:spotify:playlist:ghi", "full:spotify:playlist:jkl"}
	wantYoutube := []string{"full:youtube:abc", "revalidate:youtube:ghi"}
